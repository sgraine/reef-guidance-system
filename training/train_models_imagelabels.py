...
if __name__ == '__main__':
    ...
    #%%% Cross-Entropy Loss %%%
    # class_weights = torch.tensor([1,8], dtype=torch.float)
    ...
    for epoch in range(epochs):
        ...
        wandb.log({"prec_deploy_train":per_class_prec_train[1],
            "prec_no-deploy_train":per_class_prec_train[0]}, step=epoch)

        wandb.log({"recall_deploy_train":per_class_recall_train[1],
        ...
        wandb.log({"prec_deploy_val":per_class_prec_val[1],
            "prec_no-deploy_val":per_class_prec_val[0]}, step=epoch)

        wandb.log({"recall_deploy_val":per_class_recall_val[1],
